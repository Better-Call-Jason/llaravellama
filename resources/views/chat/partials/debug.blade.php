@if($debugEnabled)
    <div id="debug-info" style="position: fixed; top: 5%; left: 30%; z-index: 9999; background: rgba(0,0,0,0.8); color: white; padding: 10px; width: 50%; font-size: 12px; height: 50%; overflow-y: auto;">
